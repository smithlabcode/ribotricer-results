...
if [ "$ref" = "hg38" ]; then
    echo "hg38"
    gtf="/home/cmb-panasas2/wenzhenl/genomes/hg37/annotation/gencode.v25.annotation.gtf"
...
samtools index RNA_CCDS_lengths.bam
rna="$db/RNA_CCDS_lengths.bam"
...
python $scripts/psite_trimmed.py $rna --minrdlen 28 --maxrdlen 30 --subdir RNA --tallyfile tallies.txt --cdsbed gencode.annotation.bed -p 16 -v > 4psite.log
